                      ...
                      #div(class="outer",
                          ...
                          fluidRow(
                            ...
                            column(6, align="center",
                                   "In select matatus riders can rate the matatu along various categories.
                                   This page shows results by matatu."
                            )
                          ),
                          fluidRow(
                            column(3,
                          ...
                          fluidRow(
                            ...
                            column(6, align="center",
                                   "We'll be adding stickers to more matatus. As we do, we'll add to this site -- showing ratings by sacco, matatus within saccos, etc. Check back again soon!"
                            )
                          ),
                          fluidRow(
